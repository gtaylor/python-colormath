...
def _color_objects():
    """
    Awful hack to get around circular imports.
    """
...
def _transfer_common(old_cobj, new_cobj):
    """
    Transfer illuminant and observer data to a new color object.
    """
